...
export default function NotebooksContainer () {
  ...
  return (
    <div className="w-full grid grid-cols-4 gap-4">
      <div className="group cursor-pointer w-full h-48 space-y-2 flex flex-col justify-center items-center border-2 border-dashed border-border rounded-xl hover:bg-card transition-colors duration-300">
